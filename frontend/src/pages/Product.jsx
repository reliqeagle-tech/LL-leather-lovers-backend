        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: THUMB_GAP, padding: '2px 0' }}>
          {images.map((img, i) => (
            <button key={i} onClick={() => onSelect(img, i)}
              ...
              <img src={getOptimizedImage(img, 80)} alt={`view-${i}`}
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: THUMB_GAP, padding: '2px 0' }}>
          {images.map((img, i) => (
            <button key={i} onClick={() => onSelect(img, i)}
              ...
              <img src={getOptimizedImage(img, 80)} alt={`m-${i}`}
...
const Product = () => {
  ...
  const productUrl = productData?.slug
    ? `https://llleatherlovers.com/product/${productData.category}/${productData.subCategory}/${productData.slug}`
    : `https://llleatherlovers.com/sku/${sku}`;
            ...
            <div className="product-gallery-wrap lg:sticky lg:top-24 self-start" style={{ overflow: 'hidden', maxWidth: '100%', width: '100%' }}>
              ...
              <div className="hidden sm:flex flex-row gap-3" style={{ alignItems: 'flex-start' }}>
                ...
                <div className="main-img-wrap overflow-hidden relative"
                  ...
                  <img src={getOptimizedImage(image, 700)} loading="eager" fetchPriority="high" decoding="async" alt={productData.name} className="main-img"
              ...
              <div className="flex sm:hidden flex-col gap-3" style={{ width: '100%', maxWidth: '100%' }}>
                <div className="rounded-2xl overflow-hidden relative"
                  ...
                  <img src={getOptimizedImage(image, 320)} loading="eager" fetchPriority="high" decoding="async" alt={productData.name}
