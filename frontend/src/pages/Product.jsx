        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-[55%]">
            ...
            <h1 className="text-white font-light leading-tight mb-4"
              style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 'clamp(24px,3.5vw,38px)' }}>
              {productData.name}
            </h1>
            ...
            <div className="mb-6 pb-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              {productData.discountPrice > 0 && productData.discountActive ? (
                <div className="flex items-center gap-3">
                  <span className="text-white/40 line-through" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '22px' }}>{currency}{displayPrice.toFixed(2)}</span>
                  <span className="text-green-400 font-semibold" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '34px' }}>
                ...
                <div>
                  <span className="text-white font-light" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '34px' }}>
                    {currency}{displayPrice.toFixed(2)}
                  </span>
