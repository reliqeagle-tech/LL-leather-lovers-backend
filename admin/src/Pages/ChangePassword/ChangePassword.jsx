...
//                 </div>
//                 <h1 className='text-center text-sm lg:text-[25px] font-bold text-gray-800 leading-tight mt-1 mb-4 lg:mb-8'>Welcome Back <br /> <span className='text-primary'>You can change your password from here</span></h1>

//                 <form className='w-full px-16 mt-3 mb-8'>
//                     <div className='form-group mb-4 w-full'>
//                         <h4 className='text-[16px] text-gray-700 font-medium mb-1 ml-2 '>New Password</h4>
...
//                     </div>
//                     <div className='form-group mb-4 w-full'>
//                         <h4 className='text-[16px] text-gray-700 font-medium mb-1 ml-2 '>Confirm Password</h4>
//                         <div className='relative w-full'>
//                             <input type={isPasswordShow2 === false ? 'password' : 'text'} className='w-full h-[40px] lg:h-[45px] border-2 border-gray-300 rounded-md focus:border-gray-600 focus:outline-none px-3' />
//                             <Button className='!absolute top-[5px] right-[10px] z-50 !rounded-full !w-35px !min-w-[35px] !h-[35px] !text-gray-600' onClick={() => setIsPasswordShow2(!isPasswordShow2)}>
//                                 {
//                                     isPasswordShow2 === false ? <FaRegEye className='lg:text-lg' /> : <FaRegEyeSlash className='lg:text-lg' />
//                                 }
//                             </Button>
//                         </div>
//                     </div>
