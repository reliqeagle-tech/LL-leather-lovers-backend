...
const Add = ({ token }) => {
    ...
    const resetForm = () => {
        ...
        setInchSizes([]); setImages(Array(10).fill(null)); setSizeType("standard"); setCategory("Men"); setSubCategory("Topwear"); setBestseller(false); setValErrs([]); setSizeErr(false); setShowDraftPage(false);
    };
