...
const columns = [
  { id: 'image', label: 'Category Image', minWidth: 200 },
  { id: 'catName', label: 'Category Name', minWidth: 200 },
  { id: 'subCatName', label: 'Sub Category Name', minWidth: 350 },
    ...
    <>
      ...
      <div className='my-3 card shadow-md bg-white sm:rounded-lg'>
              <div className='flex flex-cols items-center justify-between px-3 py-5 bg-[#fff]'>
                <h2 className='text-lg font-semibold text-gray-700 w-[30%]'>Sub CategoryList <span className='text-gray-500 font-medium'>(Material UI table)</span></h2>
                <div className='col ml-auto flex items-center justify-end gap-2'>
                  ...
                  <Button className='!bg-[#3872fa] !text-white !py-1 !px-3 !rounded-md !text-[13px] gap-2 w-full lg:w-[70%]' onClick={()=>context.setIsOpenFullScreenPanel({open:true, modal:'Add New Sub Category'})}><FaPlus className='text-lg' />Add New Sub Category</Button>
                </div>
              </div>
